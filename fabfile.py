...
env.application_name = 'user_server'   # name of webapp
env.root_package_name = 'user_server'  # name of app in webapp
...
# git repository url
env.remote_repo_url = 'git@git.net:user_server.git'
...
def dev():
    ...
    env.server_name = 'user_server-dev.net'
    env.short_server_name = 'user_server-dev'
...
def test():
    """Define test stage"""
    env.roledefs = {
        'web': ['user_server-test.net'],
        'lb': ['lb.user_server-test.net'],
    }
    # env.user = 'root'  # user for ssh
    env.backends = ['127.0.0.1']
    env.server_name = 'user_server-test.net'
    env.short_server_name = 'user_server-test'
    env.static_folder = '/site_media/'
    env.server_ip = ''
    env.no_shared_sessions = False
    env.server_ssl_on = True
    env.path_to_cert = '/etc/ssl/certs/user_server.net.pem'
    env.path_to_cert_key = '/etc/ssl/private/user_server.net.key'
    env.goal = 'test'
    env.socket_port = ''
...
def preprod():
    ...
    env.roledefs = {
        'web': ['user_server-pprd.net'],
        'lb': ['lb.user_server-pprd.net'],
    }
    # env.user = 'root'  # user for ssh
    env.backends = env.roledefs['web']
    env.server_name = 'user_server-pprd.net'
    env.short_server_name = 'user_server-pprd'
    env.static_folder = '/site_media/'
    env.server_ip = ''
    env.no_shared_sessions = False
    env.server_ssl_on = True
...
def prod():
    ...
    env.roledefs = {
        'web': ['user_server.net'],
        'lb': ['lb.user_server.net']
    }
    # env.user = 'root'  # user for ssh
    env.backends = env.roledefs['web']
    env.server_name = 'user_server.net'
    env.short_server_name = 'user_server'
    env.static_folder = '/site_media/'
    env.server_ip = ''
    env.no_shared_sessions = False
    env.server_ssl_on = True
